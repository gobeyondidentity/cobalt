...
// Package e2e provides end-to-end hardware tests for DOCA ComCh transport.
...
//
// Run with: go test -tags=hardware -v -run TestDOCA ./test/e2e/...
//
// Required environment variables:
//   - DOCA_PCI_ADDR: DPU PCI address (default: 0000:03:00.0)
//   - DOCA_REP_PCI_ADDR: Representor PCI address (default: 0000:01:00.0)
...
// Using tmfifo_net0 address (192.168.100.2) as default for DPU communication
const (
	defaultDOCAPCIAddr    = "0000:03:00.0" // Full PCI address with domain prefix
	defaultDOCARepPCIAddr = "0000:01:00.0"
	defaultDOCAServerName = "secure-infra"
	defaultNexusPort      = "18080"
	defaultLocalAPIPort   = "9443"
	defaultGRPCPort       = "18051"
	defaultBF3IP          = "192.168.100.2" // tmfifo_net0 address
)
