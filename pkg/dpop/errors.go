...
// JTI Cache errors (used internally by MemoryJTICache)
var (
...
// ErrReplayDetected creates an error when a jti has already been used.
func ErrReplayDetected(jti string) *DPoPError {
	return &DPoPError{
		Code:    ErrCodeReplay,
