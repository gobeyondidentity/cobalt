...
Secure Infrastructure encrypts all local databases at rest. This document explains how encryption keys work and when you might need to manage them manually.
